...
} from "@server/game/combat/special-attacks/implementations/BurningClawsSpec";
import { setWeaponSpecialAttackRuntimeMetadata } from "@server/game/combat/special-attacks/WeaponSpecialAttackScript";
