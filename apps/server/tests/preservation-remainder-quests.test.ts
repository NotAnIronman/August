...
import {
    ...
    watchtowerQuest,
} from "@server/content/gamemodes/vanilla/quests/definitions/preservation-remainder";
import type { QuestDefinition } from "@server/content/gamemodes/vanilla/quests/types";
import { getSpinningRecipeById } from "@server/content/gamemodes/vanilla/skills/crafting/spinningData";
