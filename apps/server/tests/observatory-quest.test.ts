...
import type { IScriptRegistry, ItemOnItemHandler, ScriptServices } from "@server/game/scripts/types";
import { observatoryQuest } from "@server/content/gamemodes/vanilla/quests/definitions/observatory-quest";
import { ITEM, LOC, NPC, STAGE, VARP_OBSERVATORY_QUEST } from "@server/content/gamemodes/vanilla/quests/definitions/observatory-quest/constants";
