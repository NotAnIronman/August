...
assert.equal(WeaponSpecialAttackRegistry.get(19481)?.energyCost, 65);
assert.equal(WeaponSpecialAttackRegistry.get(23630)?.energyCost, 65);
assert.equal(WeaponSpecialAttackRegistry.get(26712)?.energyCost, 65);
assert.equal(WeaponSpecialAttackRegistry.get(19478)?.energyCost, 65);
assert.equal(WeaponSpecialAttackRegistry.get(27188)?.energyCost, 65);
