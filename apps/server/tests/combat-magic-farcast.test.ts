...
import { ProjectileTimingService } from "@server/game/services/ProjectileTimingService";
import { ProjectileSystem } from "@server/game/systems/ProjectileSystem";
import { resolveMagicCastSpotAnimHeight } from "@server/game/spells/SpellDataProvider";
import type { PathService } from "@server/pathfinding/PathService";

const TEST_GAMEMODE = createTestGamemode(
    "combat-magic-farcast-test",
    "Combat magic farcast test",
);
