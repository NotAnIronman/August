...
import { type Script, parseScriptFromBytes } from "@client/engine/cs2/Script";
...
const vm = new Cs2Vm({
    ...
    objTypeLoader,
    getViewportZoomRange: () => ({ min: 256, max: 256 }),
    setViewportZoomRange: () => undefined,
    getViewportFovValues: () => ({ low: 256, high: 256 }),
    setViewportFovValues: () => undefined,
    configureTileHighlight: () => undefined,
    setTileHighlight: () => undefined,
    removeTileHighlight: () => undefined,
    clearTileHighlights: () => undefined,
