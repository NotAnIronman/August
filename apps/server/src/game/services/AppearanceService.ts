...
import { PlayerAppearance as CachePlayerAppearance } from "@august/osrs-engine/config/player/PlayerAppearance";
import { logger } from "@server/observability/logger";
import type { ServerServices } from "@server/game/ServerServices";
import type { WeaponDataEntry } from "@server/game/combat/WeaponDataProvider";
import { weaponDataEntries } from "@server/game/combat/WeaponDataProvider";
import type { PlayerAppearance as PlayerAppearanceState, PlayerState } from "@server/game/player";
import type { PlayerAnimSet } from "@server/game/systems/BroadcastScheduler";
