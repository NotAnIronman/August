import type { SoundBroadcastRequest } from "@server/network/managers/SoundManager";
import { encodeMessage } from "@server/network/messages";
import type { ServerServices } from "@server/game/ServerServices";
import type { PlayerState } from "@server/game/player";
import type { PendingLocAnimation } from "@server/game/systems/BroadcastScheduler";
