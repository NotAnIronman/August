import { PRAYER_DEACTIVATE_SOUND_ID, type PrayerName } from "@august/osrs-engine/prayer/prayers";
...
import type { DamageType, DropEligibility } from "@server/game/combat/DamageTracker";
...
import { createCombatHitEvaluator } from "@server/game/combat/engine/CombatHitEvaluator";
import type { CombatHitEvaluator } from "@server/game/combat/engine/CombatHitEvaluator";
...
import type { DropRecipient } from "@server/game/drops/types";
