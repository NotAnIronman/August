...
import { VARP_MAP_CLOCK } from "@server/widgets/minimapOrbs";
import type { ServerServices } from "@server/game/ServerServices";
import type { ActionEffect, ActionExecutionResult } from "@server/game/actions";
...
import type { PlayerState, SkillSyncUpdate } from "@server/game/player";
