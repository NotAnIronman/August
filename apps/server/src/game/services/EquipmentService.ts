import { VARP_AUTOCAST_SPELLPOS, VARP_SPECIAL_ATTACK } from "@august/game-model/state/vars";
import { EquipmentSlot } from "@august/osrs-engine/config/player/Equipment";
import {
    DEFAULT_WEAPON_CATEGORY,
    resolveWeaponCategoryFromObj,
} from "@august/osrs-engine/config/player/WeaponCategory";
import { getEquipmentItemDefinition, getItemDefinition } from "@server/data/items";
import { logger } from "@server/observability/logger";
import { DisplayMode, getDefaultInterfaces } from "@server/widgets/WidgetManager";
...
import { getCategoryForWeaponInterface } from "@server/game/combat/WeaponInterfaces";
import { MagicStaffValidator } from "@server/game/combat/plugins/MagicStaffValidator";
import {
    ensureEquipArrayOn,
    ...
    getSkillcapeSpotId,
    inferEquipSlot,
} from "@server/game/equipment";
import type { PlayerAppearance as PlayerAppearanceState, PlayerState } from "@server/game/player";
