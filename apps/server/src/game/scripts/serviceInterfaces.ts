import type { PrayerName } from "@august/osrs-engine/prayer/prayers";
...
import type { StructTypeLoader } from "@august/osrs-engine/config/structtype/StructTypeLoader";
import type { ProjectileLaunch } from "@august/protocol/projectiles/ProjectileLaunch";
import type { ItemDefinition } from "@server/data/items";
...
import type { InterfaceMount } from "@server/widgets/viewport";
import type {
    DoorPartnerResult,
    DoorToggleResult,
    GateDef,
    GateOpenStyle,
    GatePair,
} from "@server/world/DoorDefinitions";
import type { DoorStateManager } from "@server/world/DoorStateManager";
import type { TransformableLocDefinition } from "@server/world/LocTransforms";
import type { ActionRequest } from "@server/game/actions";
...
// ============================================================================
// Provider Registration (for gamemode/content-module data provider registration)
// ============================================================================
...
import type { ScriptTaskOwner } from "@server/game/systems/ScriptScheduler";
import type {
    InstanceAreaCopy,
    QuestInstanceHandle,
    QuestInstanceSpec,
...
import type {
    ...
    TemporaryLocScope,
} from "@server/game/services/LocationService";
...
export {
    ...
    buildTabChangeArgs,
} from "@server/game/collectionlog";
...
export { DisplayMode } from "@server/widgets/viewport";
export type { InterfaceMount } from "@server/widgets/viewport";
export { BaseComponentUids } from "@server/widgets/viewport/ViewportEnumService";

export type { WidgetAction } from "@server/widgets/WidgetManager";

// ============================================================================
// Smithing message types (re-exported for gamemode consumption)
// ============================================================================

export type { SmithingOptionMessage, SmithingServerPayload } from "@server/network/messages";
...
export interface ProviderRegistrationFacade {
    ...
    registerFallbackSpecialAttack(provider: FallbackSpecialAttackProvider): void;
...
export { damageTracker } from "@server/game/combat/DamageTracker";
export { multiCombatSystem } from "@server/game/combat/MultiCombatZones";
export { getItemDefinition, loadItemDefinitions } from "@server/data/items";
export type {
    ItemDefinition,
    ItemBonuses,
    ItemRequirements,
    EquipmentType,
    WeaponInterface,
} from "@server/data/items";

// Emote and equipment helpers for gamemode consumption
export { getEmoteSeq } from "@server/game/emotes";
export { getSkillcapeSeqId, getSkillcapeSpotId } from "@server/game/equipment";

// Autocast state helpers for gamemode consumption
export { applyAutocastState, clearAutocastState } from "@server/game/combat/AutocastState";
...
export {
    ...
    PORT_SARIM_RETURN_X,
    PORT_SARIM_RETURN_Y,
} from "@server/game/sailing/SailingInstance";

// Account summary helpers for gamemode consumption
export { getAccountSummaryTimeMinutes } from "@server/game/accountSummaryTime";

// Teleport spell data for gamemode consumption
export { getTeleportByWidgetId } from "@server/data/teleportDestinations";
export type { TeleportSpellData } from "@server/data/teleportDestinations";

// Spell widget lookup for gamemode consumption
export { getSpellWidgetId } from "@server/data/spellWidgetLoader";

// Queue task types for gamemode consumption
export { WaitCondition } from "@server/game/model/queue/QueueTask";

// Timer keys for gamemode consumption
export { HOME_TELEPORT_TIMER } from "@server/game/model/timer/Timers";

// Rune validation types for gamemode consumption
export { RuneValidator } from "@server/game/spells/RuneValidator";
export type {
    InventoryItem as RuneInventoryItem,
    RuneValidationResult,
} from "@server/game/spells/RuneValidator";

// Skill action payload types for gamemode consumption
export type { SkillBoltEnchantActionData } from "@server/game/actions/skillActionPayloads";
