...
import { DEBUG_PLAYER_IDS, Tile } from "@server/game/actor";
...
import { PlayerInteractionSystem, PlayerRepository } from "@server/game/interactions/PlayerInteractionSystem";
import {
    FollowInteractionKind,
    GroundItemInteractionState,
    PlayerInteractionState,
} from "@server/game/interactions/types";
import { NpcState } from "@server/game/npc";
import { PlayerState } from "@server/game/player";
import type { MovementProcessor } from "@server/game/movement/engine/MovementProcessor";
