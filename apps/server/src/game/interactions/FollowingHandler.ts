...
import { hasDirectReachToArea } from "@server/pathfinding/DirectReach";
...
import { LockStateChecks } from "@server/game/model/LockState";
import { PlayerState } from "@server/game/player";
import type { PlayerRepository } from "@server/game/interactions/PlayerInteractionSystem";
import { FollowInteractionKind, FollowInteractionState, PlayerInteractionState } from "@server/game/interactions/types";
