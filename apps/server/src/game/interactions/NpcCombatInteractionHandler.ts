...
import { AttackStyle, getAttackStyle } from "@server/game/combat/WeaponDataProvider";
...
import type { NpcCombatInteractionState, PlayerInteractionState } from "@server/game/interactions/types";
