...
import type { WeaponSpecialAttackScript } from "@server/game/combat/special-attacks/WeaponSpecialAttackScript";
 ...
 *
 * initialize() scans the sibling implementations directory at startup and
 ...
 */
export class WeaponSpecialAttackRegistry {
    ...
    static initialize(): void {
        ...
        try {
            const directory = path.join(__dirname, "implementations");
