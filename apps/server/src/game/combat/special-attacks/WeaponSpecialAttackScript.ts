...
export interface WeaponSpecialAttackLargeTargetHit {
...
export interface WeaponSpecialAttackTargeting {
    ...
    readonly largeTargetExtraHit?: WeaponSpecialAttackLargeTargetHit;
    /** Ordered extra rolls applied when a large target meets each size threshold. */
    readonly largeTargetExtraHits?: readonly WeaponSpecialAttackLargeTargetHit[];
}
