 ...
 * one minute. The effect is inactive while the Staff of light is unequipped,
 * but resumes if it is re-equipped before the original expiry.
 */
export class StaffOfLightSpec implements WeaponSpecialAttackScript {
    readonly itemId = STAFF_OF_LIGHT_ITEM_ID;
...
export const STAFF_OF_LIGHT_SPEC = Object.freeze(new StaffOfLightSpec());
