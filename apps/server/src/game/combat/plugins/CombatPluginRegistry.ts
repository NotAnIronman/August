import { ARROW_LAUNCH_DELAY_TICKS, ARROW_TRAVEL_TIME_TICKS } from "@server/game/combat/AmmoSystem";
import { CombatAttackStyle } from "@server/game/combat/model/CombatAttack";
import { type WeaponCombatContext, type WeaponCombatProfile } from "@server/game/combat/plugins/WeaponCombatProfile";
import { CORE_SPECIAL_ATTACK_PROFILES } from "@server/game/combat/special-attacks/implementations";

export { ANCIENT_AUTOCAST_STAFF_IDS, MagicStaffValidator } from "@server/game/combat/plugins/MagicStaffValidator";
