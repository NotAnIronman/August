...
} from "@server/game/combat/OsrsHitsplatIds";
...
export interface FallbackSpecialAttackEffects {
    freezeTicks?: number;
    healFraction?: number;
...
export class CombatEffectApplicator {
    ...
    applySpecialEffects(
        ...
        target: NpcState,
        damageDealt: number,
        effects: FallbackSpecialAttackEffects | undefined,
        tick: number,
    ): void {
        if (!effects) return;
    ...
    private applyNpcFractionalStatDrains(target: NpcState, effects: FallbackSpecialAttackEffects): void {
    ...
    private applyNpcDamageStatDrains(
        target: NpcState,
        effects: FallbackSpecialAttackEffects,
        damageDealt: number,
        tick: number,
    ): void {
