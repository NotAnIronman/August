import type { ProjectileArchetypeName, ProjectileLifeModel } from "@server/game/projectiles/ProjectileType";
// =============================================================================
// Provider Registration & Delegation
// =============================================================================
import { getProviderRegistry } from "@server/game/providers/ProviderRegistry";

export type { ProjectileArchetypeName, ProjectileLifeModel } from "@server/game/projectiles/ProjectileType";
export {
    PROJECTILE_ARCHETYPES,
    calculateProjectileLifeFrames,
} from "@server/game/projectiles/ProjectileType";
