...
import { type ChargeTracker, createChargeTracker } from "@server/game/combat/DegradationSystem";
...
import type { CombatAttributeStore } from "@server/game/combat/state/CombatAttributeStore";
