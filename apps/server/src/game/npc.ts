...
import type {
    ...
    NpcEffectType,
} from "@server/game/combat/NpcEffectImmunity";
import {
...
import { AGGRESSION_TIMER_TICKS, TARGET_SEARCH_INTERVAL } from "@server/game/combat/NpcAggression";
import { CombatEntityType, playerCombatEntityRef } from "@server/game/combat/model/CombatEntityRef";
...
import type { InteractionTargetType } from "@server/game/interactionIndex";
