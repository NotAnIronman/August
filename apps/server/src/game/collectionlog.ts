 ...
 *   4. Load category/item tracking data from data/catalogs/collection-log.json
 *
...
} from "@server/game/notifications/CollectionLogNotification";
...
/**
 * Load collection log tracking data from data/catalogs/collection-log.json.
