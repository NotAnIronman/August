...
} from "@server/game/death/ItemProtectionCalculator";
...
} from "@server/game/death/DeathHookRegistry";

// Player Death Service
export { PlayerDeathService } from "@server/game/death/PlayerDeathService";
