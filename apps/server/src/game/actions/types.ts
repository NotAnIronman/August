...
import type { CoreActionPayloadByKind } from "@server/game/actions/actionPayloads";
import type { SkillActionPayloadByKind } from "@server/game/actions/skillActionPayloads";
