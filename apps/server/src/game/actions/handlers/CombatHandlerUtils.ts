...
import { AmmoType, getAmmoType, isDarkBowWeapon } from "@server/game/combat/AmmoSystem";
import { AttackType } from "@server/game/combat/AttackType";
import { DegradationSystem, getChargesUsed, setChargesUsed } from "@server/game/combat/DegradationSystem";
...
import type { CombatActionServices, HitPayload } from "@server/game/actions/handlers/CombatActionHandler";
