...
} from "@server/widgets/hooks/DialogInterfaceHooks";
import { VARBIT_BUSY } from "@server/widgets/InterfaceService";
import type { ServerServices } from "@server/game/ServerServices";
import type { PlayerState } from "@server/game/player";
import { ScriptDialogKind, type ScriptSkillMultiRequest } from "@server/game/scripts/types";
