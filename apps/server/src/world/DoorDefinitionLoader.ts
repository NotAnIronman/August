...
import { readDoorCatalog, resolveDoorCatalogPath } from "@server/world/DoorCatalogFile";
...
export class DoorDefinitionLoader {
    ...
    constructor(catalogPath: string = serverCatalogPath("doors.json"), watchEnabled: boolean = false) {
