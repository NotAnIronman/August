...
import { completeQuest, countCarriedItem, isQuestComplete } from "@server/content/gamemodes/vanilla/quests/QuestService";
import { type DialogueStep, startConversation } from "@server/content/gamemodes/vanilla/quests/dialogue";
import type { QuestDefinition, QuestItemRequirement } from "@server/content/gamemodes/vanilla/quests/types";
import { DT_DIRECT_PREREQUISITES } from "@server/content/gamemodes/vanilla/quests/definitions/desert-treasure-series/constants";
import { trackPlayer } from "@server/content/gamemodes/vanilla/quests/definitions/desert-treasure-series/state";
