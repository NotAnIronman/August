...
import { registerJunglePotionInteractions } from "@server/content/gamemodes/vanilla/quests/definitions/jungle-potion/interactions";
import { buildJunglePotionJournal } from "@server/content/gamemodes/vanilla/quests/definitions/jungle-potion/journal";

export { JUNGLE_POTION_QUEST_KEY } from "@server/content/gamemodes/vanilla/quests/definitions/jungle-potion/constants";
