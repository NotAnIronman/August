...
import { completeQuest, countCarriedItem, getQuestStage, setQuestStage, takeQuestItems } from "@server/content/gamemodes/vanilla/quests/QuestService";
import { run, sayNpc, startConversation } from "@server/content/gamemodes/vanilla/quests/dialogue";
import type { QuestDefinition } from "@server/content/gamemodes/vanilla/quests/types";
import { ITEM, LOC, NPC, STAGE } from "@server/content/gamemodes/vanilla/quests/definitions/observatory-quest/constants";
