...
import { countCarriedItem, takeQuestItems } from "@server/content/gamemodes/vanilla/quests/QuestService";
import { BLONDE_WIG_ITEM_ID, PINK_SKIRT_ITEM_ID, SKIN_PASTE_ITEM_ID } from "@server/content/gamemodes/vanilla/quests/definitions/prince-ali-rescue/constants";
