...
import { registerBlackKnightsFortressInteractions } from "@server/content/gamemodes/vanilla/quests/definitions/black-knights-fortress/interactions";
import { buildBlackKnightsFortressJournal } from "@server/content/gamemodes/vanilla/quests/definitions/black-knights-fortress/journal";

export { BLACK_KNIGHTS_FORTRESS_QUEST_KEY } from "@server/content/gamemodes/vanilla/quests/definitions/black-knights-fortress/constants";
