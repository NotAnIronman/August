...
import { choose, option, run, sayNpc, sayPlayer } from "@server/content/gamemodes/vanilla/quests/dialogue";
...
import { ITEM, NPC, REQUIRED_SUPPLIES } from "@server/content/gamemodes/vanilla/quests/definitions/death-plateau/constants";
