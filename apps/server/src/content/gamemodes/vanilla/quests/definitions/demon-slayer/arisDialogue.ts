...
import { carriesItem, takeItem } from "@server/content/gamemodes/vanilla/quests/definitions/demon-slayer/items";
import { setDemonStage } from "@server/content/gamemodes/vanilla/quests/definitions/demon-slayer/state";
