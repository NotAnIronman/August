...
import { ITEM, STAGE, VARP_OBSERVATORY_QUEST } from "@server/content/gamemodes/vanilla/quests/definitions/observatory-quest/constants";
import { registerObservatoryQuestInteractions } from "@server/content/gamemodes/vanilla/quests/definitions/observatory-quest/interactions";
import { buildObservatoryQuestJournal } from "@server/content/gamemodes/vanilla/quests/definitions/observatory-quest/journal";
