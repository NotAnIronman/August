...
import { registerBarCrawlInteractions } from "@server/content/gamemodes/vanilla/quests/definitions/bar-crawl";
import {
    completeQuest,
    getQuestStage,
...
import type { DialogueStep } from "@server/content/gamemodes/vanilla/quests/dialogue";
