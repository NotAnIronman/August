...
import { createFatherAereckTalkHandler, createFatherUrhneyTalkHandler, createRestlessGhostTalkHandler } from "@server/content/gamemodes/vanilla/quests/definitions/restless-ghost/dialogue";
import {
    ITEM,
    LOC,
    NPC,
