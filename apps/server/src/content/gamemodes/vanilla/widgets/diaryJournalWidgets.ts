import { ACHIEVEMENT_DIARY_PANEL_GROUP_ID } from "@august/protocol/ui/widgets";
...
import { getDiaryAreaTasks } from "@server/content/gamemodes/vanilla/diary-tasks";
import type { IScriptRegistry, ScriptServices } from "@server/game/scripts/types";
import { openUiPanel, sendUiTabs, sendUiTextRows, wrapTextToLines } from "@server/content/gamemodes/vanilla/uikit/panelData";
 ...
 *
 * If the area's task data (server/gamemodes/vanilla/diary-tasks/data/) has
