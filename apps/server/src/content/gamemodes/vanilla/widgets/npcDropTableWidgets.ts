import { NPC_DROP_TABLE_PANEL_GROUP_ID } from "@august/protocol/ui/widgets";
import { ComponentIds, type UiIconRow } from "@august/protocol/uikit/contracts";
...
import type { NpcDropEntry, NpcDropPool, NpcDropTable } from "@server/game/drops/types";
...
export function registerNpcDropTableWidgetHandlers(
    ...
    registry.registerCommand("drops", ({ player, args }) => {
        ...
        permission: "player",
        owner: "content:vanilla:npc-drop-table",
        summary: "Open the imported drop table for an NPC id.",
    });
    ...
    registry.registerCommand("dropsdebug", ({ player, args }) => {
        ...
        owner: "developer:drop-diagnostics",
        hidden: true,
    });
