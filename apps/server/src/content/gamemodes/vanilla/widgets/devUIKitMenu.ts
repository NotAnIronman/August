...
import { getLastEditedNpcId, openDialogueEditorForNpc } from "@server/content/gamemodes/vanilla/widgets/devDialogueEditor";
import {
    openUiPanel,
    packUid,
    sendUiControls,
...
export function registerDevUIKitMenu(
    ...
    registry.registerCommand("dev", ({ player }) => {
        ...
        owner: "developer:uikit",
        summary: "Open the UIKit developer showcase.",
    });

    // ::Rename <archiveId>:<frame> <common name>
    // e.g. ::Rename 169:0 minimap.compass-rose
    // Writes to data/catalogs/client/sprite-names.json, which the sprite
