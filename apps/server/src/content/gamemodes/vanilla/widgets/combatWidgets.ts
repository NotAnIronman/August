...
import { DisplayMode } from "@server/game/scripts/types";
import { applyAutocastState, clearAutocastState } from "@server/game/scripts/types";
...
import { resolveAutocastSlot } from "@server/game/spells/AutocastSlotResolver";
...
} from "@server/content/gamemodes/vanilla/combat/InstantUtilitySpecialCatalog";
