...
import { VARBIT_SIDE_JOURNAL_TAB, VARP_SIDE_JOURNAL_STATE } from "@august/game-model/state/vars";
import type {
...
import { GameframeTab, SCRIPT_FOCUS_TAB } from "@server/widgets/InterfaceService";
