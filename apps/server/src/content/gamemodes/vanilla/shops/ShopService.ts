...
import type { ShoppingServices } from "@server/game/scripts/types";
import { encodeMessage, type ShopServerPayload } from "@server/network/messages";
import type { ShopOpenData } from "@server/content/gamemodes/vanilla/shops/ShopInterfaceHooks";
import type { ShopStockEntry } from "@server/content/gamemodes/vanilla/shops/ShopManager";
import { ShopManager } from "@server/content/gamemodes/vanilla/shops/ShopManager";
import { SHOP_INTERFACE_ID } from "@server/content/gamemodes/vanilla/shops/shopConstants";
