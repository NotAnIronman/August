...
import { type InventoryAddResult, type PlayerState } from "@server/game/player";
import { getAllShopDefinitions } from "@server/content/gamemodes/vanilla/shops/definitions";
