...
import { CombatCategoryConst as CombatCategory } from "@server/game/combat/WeaponDataProvider";
import { getWeaponData } from "@server/game/combat/WeaponDataProvider";
import { ANCIENT_AUTOCAST_STAFF_IDS } from "@server/game/combat/plugins/MagicStaffValidator";
import { applyProjectileDefaults } from "@server/game/data/ProjectileParamsProvider";
import { VARP_DESERT_TREASURE } from "@august/game-model/state/vars";
import {
