...
import { type BankEntry, type PlayerState } from "@server/game/player";
import { getItemDefinition } from "@server/game/scripts/types";
...
import {
    ...
    type BankOpenData,
} from "@server/content/gamemodes/vanilla/banking/BankInterfaceHooks";
import type {
    BankOperationResult,
    BankServerUpdate,
    BankingProvider,
    BankingProviderServices,
} from "@server/content/gamemodes/vanilla/banking/BankingProvider";
import {
    BankLimits,
    BankMainChild,
    BankSideChild,
    ...
    WidgetGroup,
    slotToTabIndex,
} from "@server/content/gamemodes/vanilla/banking/bankConstants";
