...
export { CUSTOM_STRUCT_RANGES, CUSTOM_TASK_RANGE, ENUM_IDS } from "@server/content/gamemodes/leagues-v/data/custom/CustomContentTypes";
...
} from "@server/content/gamemodes/leagues-v/data/custom/CustomLeagueRegistry";
