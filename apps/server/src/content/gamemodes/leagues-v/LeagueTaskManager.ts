...
import { LeagueTaskIndex, type ParsedChallenge, type ParsedTask } from "@server/content/gamemodes/leagues-v/LeagueTaskIndex";
import {
...
import { syncLeaguePackedVarps } from "@server/content/gamemodes/leagues-v/leaguePackedVarps";
import { TriggerType } from "@server/content/gamemodes/leagues-v/triggers/TriggerTypes";
