...
import { buildItemSpawnerModalGroup } from "@server/content/modules/item-spawner/widget/itemSpawner.cs2";
...
export function register(registry: IScriptRegistry, services: ScriptServices): void {
    ...
    registry.registerCommand("itemspawner", (event) => {
        ...
        owner: "content:item-spawner",
        summary: "Add the developer item-spawner tool.",
    });
