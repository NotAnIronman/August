...
import type { NpcUpdateDelta } from "@server/game/npc";
import type { NpcStatusEvent } from "@server/game/npcManager";
import type { PlayerAppearance as PlayerAppearanceState } from "@server/game/player";
import type { SkillSyncUpdate } from "@server/game/player";
import type {
    ChatMessageSnapshot,
    ForcedChatBroadcast,
...
import type { NotificationPayload, SpellResultPayload } from "@server/network/messages";
...
export interface TickFrame {
    ...
    actionEffects: import("@server/game/actions").ActionEffect[];
