...
} from "@august/protocol/ui/music";
import { VARP_MUSICPLAY, VARP_MUSIC_CURRENT_TRACK } from "@august/game-model/state/vars";
...
import {
    ...
    getHitSoundForStyle,
    getMissSound,
} from "@server/game/combat/WeaponDataProvider";
