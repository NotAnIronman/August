/**
 * ServerBinaryEncoder - Encode August server messages to binary format
 *
 * Replaces JSON.stringify for server-to-client messages.
 * Binary encoding helpers for server packets.
 */
import { INSTANCE_CHUNK_COUNT, PLANE_COUNT } from "@august/game-model/world/instance/InstanceTypes";
import {
...
export class ServerPacketBuffer {
     ...
     */
    toPacket(opcode: ServerMessageId): Uint8Array {
        const length = SERVER_MESSAGE_LENGTHS[opcode];
...
export class ServerBinaryEncoder {
    ...
    encodeWelcome(tickMs: number, serverTime: number): Uint8Array {
        ...
        return this.buffer.toPacket(ServerMessageId.WELCOME);
    }
    ...
    encodeTick(tick: number, time: number): Uint8Array {
        ...
        return this.buffer.toPacket(ServerMessageId.TICK);
    }
    ...
    encodeDestination(worldX: number, worldY: number): Uint8Array {
        ...
        return this.buffer.toPacket(ServerMessageId.DESTINATION);
    }
    ...
    encodeCameraControl(payload: CameraControlPayload): Uint8Array {
        ...
        return this.buffer.toPacket(ServerMessageId.CAMERA_CONTROL);
    }
    ...
    encodeHandshake(
        ...
        return this.buffer.toPacket(ServerMessageId.HANDSHAKE);
    }
    ...
    encodeVarpSmall(varpId: number, value: number): Uint8Array {
        ...
        return this.buffer.toPacket(ServerMessageId.VARP_SMALL);
    }
    ...
    encodeVarpLarge(varpId: number, value: number): Uint8Array {
        ...
        return this.buffer.toPacket(ServerMessageId.VARP_LARGE);
    }
    ...
    encodeVarbit(varbitId: number, value: number): Uint8Array {
        ...
        this.buffer.writeInt(value);
        return this.buffer.toPacket(ServerMessageId.VARBIT);
    }
    ...
    encodePlayerSync(
        ...
        return this.buffer.toPacket(ServerMessageId.PLAYER_SYNC);
    }
    ...
    encodeNpcInfo(
        ...
        this.buffer.writeShort(packet.length);
        this.buffer.writeBytes(packet, 0, packet.length);
        return this.buffer.toPacket(ServerMessageId.NPC_INFO);
    }
    ...
    encodeInventorySnapshot(
        ...
        return this.buffer.toPacket(ServerMessageId.INVENTORY_SNAPSHOT);
    }
    ...
    encodeInventorySlot(slot: number, itemId: number, quantity: number): Uint8Array {
        ...
        return this.buffer.toPacket(ServerMessageId.INVENTORY_SLOT);
    }
    ...
    encodeSkillsSnapshot(
        ...
        return this.encodeSkillsInternal(
            ...
            totalLevel,
            combatLevel,
            ServerMessageId.SKILLS_SNAPSHOT,
        );
    }
    ...
    encodeRunEnergy(percent: number, running: boolean): Uint8Array {
        ...
        return this.buffer.toPacket(ServerMessageId.RUN_ENERGY);
    }
    ...
    encodeWidgetOpen(groupId: number, modal: boolean): Uint8Array {
        ...
        return this.buffer.toPacket(ServerMessageId.WIDGET_OPEN);
    }

    encodeWidgetClose(groupId: number): Uint8Array {
        this.buffer.reset();
        this.buffer.writeShort(groupId);
        return this.buffer.toPacket(ServerMessageId.WIDGET_CLOSE);
    }

    encodeWidgetSetRoot(groupId: number): Uint8Array {
        this.buffer.reset();
        this.buffer.writeShort(groupId);
        return this.buffer.toPacket(ServerMessageId.WIDGET_SET_ROOT);
    }
    ...
    encodeWidgetOpenSub(
        ...
        return this.buffer.toPacket(ServerMessageId.WIDGET_OPEN_SUB);
    }

    encodeWidgetCloseSub(targetUid: number): Uint8Array {
        this.buffer.reset();
        this.buffer.writeInt(targetUid);
        return this.buffer.toPacket(ServerMessageId.WIDGET_CLOSE_SUB);
    }
    ...
    encodeWidgetSetText(uid: number, text: string): Uint8Array {
        ...
        return this.buffer.toPacket(ServerMessageId.WIDGET_SET_TEXT);
    }
    ...
    encodeWidgetSetHidden(uid: number, hidden: boolean): Uint8Array {
        ...
        return this.buffer.toPacket(ServerMessageId.WIDGET_SET_HIDDEN);
    }
    ...
    encodeWidgetSetItem(uid: number, itemId: number, quantity: number): Uint8Array {
        ...
        this.buffer.writeInt(quantity);
        return this.buffer.toPacket(ServerMessageId.WIDGET_SET_ITEM);
    }
    ...
    encodeWidgetSetSprite(
        ...
        return this.buffer.toPacket(ServerMessageId.WIDGET_SET_SPRITE);
    }
    ...
    encodeWidgetSetNpcHead(uid: number, npcId: number): Uint8Array {
        ...
        this.buffer.writeInt(uid);
        this.buffer.writeShort(npcId);
        return this.buffer.toPacket(ServerMessageId.WIDGET_SET_NPC_HEAD);
    }
    ...
    encodeWidgetSetFlagsRange(
        ...
        return this.buffer.toPacket(ServerMessageId.WIDGET_SET_FLAGS_RANGE);
    }
    ...
    encodeWidgetRunScript(
        ...
        writeVars(varps);
        writeVars(varbits);
        return this.buffer.toPacket(ServerMessageId.WIDGET_RUN_SCRIPT);
    }
    ...
    encodeWidgetSetFlags(uid: number, flags: number): Uint8Array {
        ...
        this.buffer.writeInt(uid);
        this.buffer.writeInt(flags);
        return this.buffer.toPacket(ServerMessageId.WIDGET_SET_FLAGS);
    }
    ...
    encodeWidgetSetAnimation(uid: number, animationId: number): Uint8Array {
        ...
        return this.buffer.toPacket(ServerMessageId.WIDGET_SET_ANIMATION);
    }

    encodeWidgetSetPlayerHead(uid: number): Uint8Array {
        this.buffer.reset();
        this.buffer.writeInt(uid);
        return this.buffer.toPacket(ServerMessageId.WIDGET_SET_PLAYER_HEAD);
    }
    ...
    encodeWidgetSetQuestList(groups: QuestListWidgetGroup[]): Uint8Array {
        ...
        return this.buffer.toPacket(ServerMessageId.WIDGET_SET_QUEST_LIST);
    }
    ...
    encodeChatMessage(
        ...
        return this.buffer.toPacket(ServerMessageId.CHAT_MESSAGE);
    }
    ...
    encodeFriendsChat(snapshot: FriendsChatSnapshot): Uint8Array {
        ...
        return this.buffer.toPacket(ServerMessageId.FRIENDS_CHAT_UPDATE);
    }
    ...
    encodeSound(
        ...
        return this.buffer.toPacket(ServerMessageId.SOUND);
    }
    ...
    encodePlayJingle(jingleId: number, delay?: number): Uint8Array {
        ...
        return this.buffer.toPacket(ServerMessageId.PLAY_JINGLE);
    }
    ...
    encodePlaySong(
        ...
        return this.buffer.toPacket(ServerMessageId.PLAY_SONG);
    }
    ...
    encodeRunClientScript(scriptId: number, args: (number | string)[]): Uint8Array {
        ...
        return this.buffer.toPacket(ServerMessageId.RUN_CLIENT_SCRIPT);
    }
    ...
    encodeBankSnapshot(
        ...
        return this.buffer.toPacket(ServerMessageId.BANK_SNAPSHOT);
    }
    ...
    encodeBankSlot(
        ...
        return this.buffer.toPacket(ServerMessageId.BANK_SLOT);
    }
    ...
    encodeProjectiles(list: ProjectileLaunch[]): Uint8Array {
        ...
        return this.buffer.toPacket(ServerMessageId.PROJECTILES);
    }
    ...
    encodeLocChange(
        ...
        return this.buffer.toPacket(ServerMessageId.LOC_CHANGE);
    }
    ...
    encodeLocAddChange(
        ...
        return this.buffer.toPacket(ServerMessageId.LOC_ADD_CHANGE);
    }
    ...
    encodeLocDel(
        ...
        this.buffer.writeByte(level);
        this.buffer.writeByte((shape << 2) | (rotation & 3));
        return this.buffer.toPacket(ServerMessageId.LOC_DEL);
    }
    ...
    encodeLocAnim(
        ...
        return this.buffer.toPacket(ServerMessageId.LOC_ANIM);
    }
    ...
    encodeCombatState(payload: {
        ...
        return this.buffer.toPacket(ServerMessageId.COMBAT_STATE);
    }
    ...
    encodeAnim(payload: {
        ...
        return this.buffer.toPacket(ServerMessageId.ANIM);
    }
    ...
    encodePathResponse(
        ...
        return this.buffer.toPacket(ServerMessageId.PATH_RESPONSE);
    }
    ...
    encodeLoginResponse(
        ...
        return this.buffer.toPacket(ServerMessageId.LOGIN_RESPONSE);
    }
    ...
    encodeLogoutResponse(success: boolean, reason?: string): Uint8Array {
        ...
        return this.buffer.toPacket(ServerMessageId.LOGOUT_RESPONSE);
    }
    // ========================================
    // SHOP
    // ========================================
    ...
    encodeShopOpen(
        ...
        return this.buffer.toPacket(ServerMessageId.SHOP_OPEN);
    }
    ...
    encodeShopSlot(
        ...
        return this.buffer.toPacket(ServerMessageId.SHOP_SLOT);
    }

    encodeShopClose(): Uint8Array {
        this.buffer.reset();
        return this.buffer.toPacket(ServerMessageId.SHOP_CLOSE);
    }
    ...
    encodeShopMode(shopId: string, buyMode?: number, sellMode?: number): Uint8Array {
        ...
        return this.buffer.toPacket(ServerMessageId.SHOP_MODE);
    }
    ...
    encodeTradeRequest(fromId: number, fromName?: string): Uint8Array {
        ...
        return this.buffer.toPacket(ServerMessageId.TRADE_REQUEST);
    }
    ...
    encodeTradeOpen(
        ...
        return this.buffer.toPacket(ServerMessageId.TRADE_OPEN);
    }
    ...
    encodeTradeUpdate(
        ...
        return this.buffer.toPacket(ServerMessageId.TRADE_UPDATE);
    }

    encodeTradeClose(reason?: string): Uint8Array {
        this.buffer.reset();
        this.buffer.writeString(reason ?? "");
        return this.buffer.toPacket(ServerMessageId.TRADE_CLOSE);
    }
    ...
    encodeSpellResult(payload: {
        ...
        return this.buffer.toPacket(ServerMessageId.SPELL_RESULT);
    }
    ...
    encodeSmithingOpen(
        ...
        return this.buffer.toPacket(ServerMessageId.SMITHING_OPEN);
    }
    ...
    encodeSmithingMode(quantityMode: number, customQuantity: number): Uint8Array {
        ...
        this.buffer.writeByte(quantityMode);
        this.buffer.writeInt(customQuantity);
        return this.buffer.toPacket(ServerMessageId.SMITHING_MODE);
    }

    encodeSmithingClose(): Uint8Array {
        this.buffer.reset();
        return this.buffer.toPacket(ServerMessageId.SMITHING_CLOSE);
    }
    ...
    encodeCollectionLogSnapshot(
        ...
        return this.buffer.toPacket(ServerMessageId.COLLECTION_LOG_SNAPSHOT);
    }
    ...
    encodeCollectionLogCategoryCompletion(completionByTab: Record<number, boolean[]>): Uint8Array {
        ...
        return this.buffer.toPacket(ServerMessageId.COLLECTION_LOG_CATEGORY_COMPLETION);
    }
    ...
    encodeNotification(
        ...
        return this.buffer.toPacket(ServerMessageId.NOTIFICATION);
    }
    ...
    encodeDebug(payload: Record<string, unknown>): Uint8Array {
        ...
        return this.buffer.toPacket(ServerMessageId.DEBUG_PACKET);
    }
    ...
    encodeRebuildNormal(
        ...
        return this.buffer.toPacket(ServerMessageId.REBUILD_NORMAL);
    }
    ...
    encodeRebuildRegion(
        ...
        return this.buffer.toPacket(ServerMessageId.REBUILD_REGION);
    }
    ...
    encodeRebuildWorldEntity(
        ...
        return this.buffer.toPacket(ServerMessageId.REBUILD_WORLDENTITY);
    }
    ...
    encodeWorldEntityInfo(
        ...
        return this.buffer.toPacket(ServerMessageId.WORLDENTITY_INFO);
    }
