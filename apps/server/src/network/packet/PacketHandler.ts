...
import type { ClientToServer } from "@server/network/messages";
import { ServerPacketBuffer } from "@server/network/packet/ServerPacketBuffer";

// Public server facade for the OSRS action-packet registry.
export { OsrsClientPacketId, OSRS_CLIENT_PACKET_LENGTHS };
...
export function decodePacket(opcode: number, data: Uint8Array): DecodedPacket {
    ...
    switch (opcode) {
        ...
        case OsrsClientPacketId.OPPLAYER1: {
        ...
        case OsrsClientPacketId.OPPLAYER2: {
        ...
        // OPPLAYER3 (46) - Follow
        // Client: writeByteSub(ctrl), writeShort(identifier)
        case OsrsClientPacketId.OPPLAYER3: {
            const ctrlHeld = buf.readByteSub() !== 0;
            const playerIndex = buf.readShort();
        ...
        case OsrsClientPacketId.OPPLAYER4: {
            const playerIndex = buf.readShort();
        ...
        case OsrsClientPacketId.OPPLAYER5: {
        ...
        // OPPLAYER6 (48)
        // Client: writeShort(identifier), writeByteNeg(ctrl)
        case OsrsClientPacketId.OPPLAYER6: {
            const playerIndex = buf.readShort();
            const ctrlHeld = buf.readByteNeg() !== 0;
        ...
        case OsrsClientPacketId.OPPLAYER7: {
        ...
        case OsrsClientPacketId.OPPLAYER8: {
            const ctrlHeld = buf.readByte() !== 0;
            const playerIndex = buf.readShortAdd();
        ...
        case OsrsClientPacketId.OPNPC1_ALT: {
            const ctrlHeld = buf.readByte() !== 0;
        ...
        case OsrsClientPacketId.OPNPC2: {
            const npcIndex = buf.readShortAddLE();
            const ctrlHeld = buf.readByte() !== 0;
        ...
        case OsrsClientPacketId.OPNPC3: {
        ...
        case OsrsClientPacketId.OPNPC4: {
            const ctrlHeld = buf.readByteNeg() !== 0;
        ...
        // OPNPC5 (57)
        // Note: this currently comes through OsrsClientPacketId.OPNPC1 (legacy alias naming).
        // Client: writeByteAdd(ctrl), writeShortLE(identifier)
        case OsrsClientPacketId.OPNPC1: {
        ...
        case OsrsClientPacketId.OPLOCU: {
        ...
        case OsrsClientPacketId.OPLOC1: {
        ...
        case OsrsClientPacketId.OPLOC2: {
        ...
        case OsrsClientPacketId.OPLOC3: {
            const worldY = buf.readShortLE();
        ...
        case OsrsClientPacketId.OPLOC4: {
            const worldX = buf.readShortAdd();
            const locId = buf.readShortLE();
        ...
        case OsrsClientPacketId.OPLOC5: {
        ...
        case OsrsClientPacketId.OPOBJ1: {
            const ctrlHeld = buf.readByteSub() !== 0;
            const worldY = buf.readShortLE();
        ...
        case OsrsClientPacketId.OPOBJ2: {
            const worldX = buf.readShortAdd();
            const worldY = buf.readShortLE();
        ...
        case OsrsClientPacketId.OPOBJ3: {
        ...
        case OsrsClientPacketId.OPOBJ4: {
            const itemId = buf.readShortAddLE();
            const worldY = buf.readShortAddLE();
            const ctrlHeld = buf.readByteNeg() !== 0;
            const worldX = buf.readShortAdd();
        ...
        case OsrsClientPacketId.OPOBJ5: {
            const itemId = buf.readShortAdd();
            const worldX = buf.readShortLE();
            const worldY = buf.readShortLE();
            const ctrlHeld = buf.readByteSub() !== 0;
        ...
        case OsrsClientPacketId.OPNPC_U: {
            const itemSlot = buf.readShortAddLE();
            const ctrlHeld = buf.readByte() !== 0;
        ...
        case OsrsClientPacketId.OPPLAYER_U: {
            const playerIndex = buf.readShortAddLE();
            const itemId = buf.readShortAddLE();
        ...
        case OsrsClientPacketId.OPOBJ_U: {
        ...
        case OsrsClientPacketId.OPLOC_T: {
            const worldY = buf.readShortAddLE();
            const locId = buf.readShortAdd();
        ...
        case OsrsClientPacketId.OPNPC_T: {
        ...
        case OsrsClientPacketId.OPPLAYER_T: {
            const ctrlHeld = buf.readByteNeg() !== 0;
            const spellItemId = buf.readShortLE();
        ...
        case OsrsClientPacketId.OPLOC_T_ALT: {
            const spellWidget = buf.readIntLE();
            const spellChildIndex = buf.readShortAdd();
            const itemId = buf.readShortAdd();
            const worldX = buf.readShortAddLE();
        ...
        case OsrsClientPacketId.IF_BUTTONT: {
        ...
        case OsrsClientPacketId.IF_BUTTON: {
        ...
        case OsrsClientPacketId.IF_BUTTOND: {
        ...
        case OsrsClientPacketId.IF_BUTTON_SUB: {
            const widgetId = buf.readInt();
            const slot = buf.readShort();
            const itemId = buf.readShort();
        ...
        case OsrsClientPacketId.IF_TRIGGEROPLOCAL: {
        ...
        // - kits (7 bytes, -1 = 0xff)
        // - colors (5 bytes)
        case OsrsClientPacketId.APPEARANCE_SET: {
        ...
        case OsrsClientPacketId.EXAMINE_LOC: {
            const locId = buf.readShortAddLE();
        ...
        case OsrsClientPacketId.EXAMINE_NPC: {
        ...
        case OsrsClientPacketId.EXAMINE_OBJ: {
            const itemId = buf.readShort();
            const worldY = buf.readShortLE();
            const worldX = buf.readShortLE();
        ...
        case OsrsClientPacketId.MOVE_GAMECLICK: {
            const worldY = buf.readShortAddLE();
        ...
        case OsrsClientPacketId.WORLD_MAP_CLICK: {
...
export function parsePackets(data: Uint8Array): Array<{ opcode: number; packet: DecodedPacket }> {
    ...
    while (offset < data.length) {
        ...
        const expectedLength = OSRS_CLIENT_PACKET_LENGTHS[opcode];
