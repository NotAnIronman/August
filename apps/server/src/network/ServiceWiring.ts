...
import { interruptForPlayerInput } from "@server/game/actions/playerInputInterrupt";
...
import { type BinaryHandlerExtServices, registerAllHandlers } from "@server/network/handlers";
import {
    ...
    const extendedServices: BinaryHandlerExtServices = {
        ...
        openDialog: (player, request) =>
            svc.widgetDialogHandler!.openDialog(
                player,
                request as import("@server/game/actions/handlers/WidgetDialogHandler").ScriptDialogRequest,
            ),
        ...
        findRegisteredCommand: (name) => svc.scriptRegistry.findCommandRegistration(name),
        listRegisteredCommands: () => svc.scriptRegistry.listCommands(),
