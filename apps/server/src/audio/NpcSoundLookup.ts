...
import { serverCatalogPath, serverGeneratedDataPath } from "@server/paths";
...
export class NpcSoundLookup {
    ...
    initialize(): void {
        ...
        this.loadNpcSoundMapFile(serverGeneratedDataPath("npc-sounds.generated.json"));
        this.loadNpcSoundMapFile(serverCatalogPath("npc-sounds.overrides.json"));
