...
import type { ViewportEnumService } from "@server/widgets/viewport/ViewportEnumService";
import { BaseComponentUids } from "@server/widgets/viewport/ViewportEnumService";
import {
    getDesktopInterfaces,
    getRemainingTabInterfaces as getDesktopRemainingTabInterfaces,
} from "@server/widgets/viewport/desktop";
import {
    getMobileInterfaces,
    getMobileQuestTabUid,
    getMobileRemainingTabInterfaces,
} from "@server/widgets/viewport/mobile";
