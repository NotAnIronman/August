...
import { RS_TO_DEGREES } from "@august/osrs-engine/MathConstants";
import type { CacheInfo } from "@august/osrs-engine/cache/CacheInfo";
import { formatBytes } from "@august/protocol/binary";
import { checkIos, checkMobile } from "@client/core/platform/device/DeviceUtil";
import { RenderStats } from "@client/engine/rendering/core/RenderStats";
import { HudDebugPanel } from "@client/ui/components/render-stats-overlay/HudDebugPanel";
