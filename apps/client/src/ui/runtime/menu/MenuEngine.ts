import { MenuTargetType, SpellCastMetadata } from "@august/osrs-engine/MenuEntry";
import { MENU_ACTION_DEPRIORITIZE_OFFSET, MenuAction, inferMenuAction } from "@client/ui/runtime/menu/MenuAction";
