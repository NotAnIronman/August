...
import { Rasterizer2D } from "@august/osrs-engine/graphics/Rasterizer2D";
import { Rasterizer3D } from "@august/osrs-engine/graphics/Rasterizer3D";
import type { Model } from "@august/osrs-engine/model/Model";
import type { ModelLoader } from "@august/osrs-engine/model/ModelLoader";
import { SpritePixels } from "@august/osrs-engine/sprite/SpritePixels";
import type { TextureLoader } from "@august/osrs-engine/texture/TextureLoader";
import { HSL_RGB_MAP } from "@august/osrs-engine/graphics/color";
import { FONT_PLAIN_11 } from "@august/protocol/ui/fonts";
import { hasAnimatedItemIcon } from "@client/ui/runtime/item/animatedItemIcons";
import { reportRuntimeProbe } from "@client/core/diagnostics/runtimeProbe";
