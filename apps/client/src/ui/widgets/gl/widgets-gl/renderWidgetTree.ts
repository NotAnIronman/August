...
} from "@client/ui/widgets/components/TextRenderer";
import { runCs1 } from "@client/ui/widgets/cs1/runCs1";
import { resolvePlayerModelPresentation } from "@client/ui/widgets/model/playerModelPresentation";
import {
...
import { MinimapRenderer } from "@client/ui/widgets/gl/MinimapRenderer";
import { drawChooseOptionMenu } from "@client/ui/widgets/gl/widgets-gl/menu/ChooseOptionMenu";
import { GLRenderer } from "@client/ui/widgets/gl/renderer";
import {
    ClipRect,
    ScissorStack,
    ...
    calculateType9Clip,
    isClipValid,
} from "@client/ui/widgets/gl/scissor";
import { type SpriteMaskData, TextureCache } from "@client/ui/widgets/gl/widgets-gl/textures/TextureCache";
import { ensureWidgetInputBridge } from "@client/ui/widgets/gl/widgets-gl/input/WidgetInputBridge";
import type { WidgetNode } from "@client/ui/widgets/WidgetNode";
import {
    DEBUG_CLICK_AREAS,
    CANCEL_SELECTION_HANDLER,
    EMPTY_WIDGETS,
} from "@client/ui/widgets/gl/widgets-gl/constants";
import {
...
} from "@client/ui/widgets/gl/widgets-gl/interactionMenuCache";
import type { CachedClickTarget, WidgetClickMeta } from "@client/ui/widgets/gl/widgets-gl/clickTypes";
import type { GLRenderOpts } from "@client/ui/widgets/gl/widgets-gl/glRenderOpts";
import { drawLine, drawThickLine } from "@client/ui/widgets/gl/widgets-gl/drawLines";
import { renderArcWidget } from "@client/ui/widgets/gl/widgets-gl/arcWidget";
import { drawScrollBar } from "@client/ui/widgets/gl/widgets-gl/scrollbarDraw";
import { drawWorldMapLabelGL, getWorldMapFlashTexture } from "@client/ui/widgets/gl/widgets-gl/worldMapLabels";
import { scaleLogicalPixels } from "@client/ui/widgets/gl/widgets-gl/scaleLogicalPixels";
import { ps } from "@client/ui/widgets/gl/widgets-gl/profilingState";
import { FONT_VERDANA_11, FONT_VERDANA_13, FONT_VERDANA_15 } from "@august/protocol/ui/fonts";
import type { WorldMapLabelDraw, WorldMapLabelMetrics } from "@client/ui/widgets/gl/widgets-gl/worldMapLabels";
...
export function renderWidgetTreeGL(glr: GLRenderer, root: Widget, opts: GLRenderOpts) {
    ...
    // Expose clicks registry to canvas for ChooseOptionMenu.ts hover detection
    ...
    // Give the widget input bridge a handler for a pinned Choose Option menu on right-click.
    ...
    try {
        ...
        input.setMenuHandler((x: number, y: number) => {
            ...
            try {
                ...
                // GALLERY_CELL_BASE/LABEL_BASE - see @august/protocol/uikit/
                // contracts) already handle right-click themselves
                    ...
                    if (!Number.isNaN(uidNum) && getByUid) {
                        ...
                        if (w && !(w as any).__dummyRoot) {
                            ...
                            if (real) {
                                ui.mouseX = x | 0;
                                ui.mouseY = y | 0;
                                const { widgetEntriesToSimple } = require("@client/ui/runtime/menu/MenuBridge");
                                const menuState = new MenuState();
