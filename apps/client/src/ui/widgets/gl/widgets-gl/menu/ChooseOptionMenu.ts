...
import { getClientCycle } from "@client/core/network/ServerConnection";
import { getUiScale } from "@client/ui/runtime/UiScale";
import { FONT_BOLD_12 } from "@august/protocol/ui/fonts";
import type { MenuClickContext } from "@client/ui/runtime/menu/MenuEngine";
import { MenuState } from "@client/ui/runtime/menu/MenuState";
import { drawTextGL as UI_drawTextGL } from "@client/ui/widgets/components/TextRenderer";
...
export function drawChooseOptionMenu(
    ...
    const closeAllMenus = () => {
        ...
        try {
            ...
            // Also consume the click in WidgetInputBridge to reset held-state tracking.
