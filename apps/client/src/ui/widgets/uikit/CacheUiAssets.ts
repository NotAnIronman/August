...
import { resolveSpriteByCommonName } from "@client/ui/widgets/uikit/SpriteNameCache";
...
export type CacheUiAssetId = (typeof CacheUiAssetKey)[keyof typeof CacheUiAssetKey];
...
export const CACHE_UI_ASSETS: Readonly<Partial<Record<CacheUiAssetId, NamedSpriteAsset>>> = {
...
function resolveAssetDefinition(assetKey: string): CacheUiAsset | undefined {
    ...
    // Anything named via ::rename (data/catalogs/client/sprite-names.json) resolves
