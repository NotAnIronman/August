...
} from "@august/protocol/ui/widgets/custom/journalPanel.cs2";
...
} from "@client/ui/widgets/uikit/CacheUiAssets";
...
import {
    ...
    pollSpriteNames,
} from "@client/ui/widgets/uikit/SpriteNameCache";
import { spriteRefKey } from "@august/protocol/uikit/spriteNames";
...
let gallerySpriteSearchController: import("@client/ui/widgets/uikit/SearchController").UiSearchController | undefined;
...
function cacheSpriteGallery(widgetManager: any): void {
    ...
    for (let index = 0; index < ComponentIds.MAX_SPRITE_GALLERY_CELLS; index++) {
        ...
        // data/catalogs/client/sprite-names.json / ::rename); otherwise falls
...
let dialogueSearchController: import("@client/ui/widgets/uikit/SearchController").UiSearchController | undefined;
