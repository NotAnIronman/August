import { SKILL_GUIDE_PANEL_GROUP_ID } from "@august/protocol/ui/widgets/custom/journalPanel.cs2";
...
/**
 * Skill guide, rebuilt with the UI kit (see @client/ui/widgets/uikit).
 *
