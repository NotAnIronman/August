import type { TradeActionClientPayload } from "@client/core/network/server-connection/types/messages";
import type { WidgetActionClientPayload } from "@client/core/network/server-connection/types/widgets";
