import type { SmithingServerPayload } from "@client/core/network/server-connection/types/index";
import { cloneSmithingState, createDefaultSmithingState } from "@client/core/network/server-connection/domain/defaults";
import { state } from "@client/core/network/server-connection/state";
import { sanitizeSmithingOption } from "@client/core/network/server-connection/normalization/InboundPayloads";
