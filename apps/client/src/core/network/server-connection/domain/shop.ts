import type { ShopServerPayload, ShopWindowState } from "@client/core/network/server-connection/types/index";
import { cloneShopState, createDefaultShopState } from "@client/core/network/server-connection/domain/defaults";
import { state } from "@client/core/network/server-connection/state";
import { sanitizeShopStockEntryMessage } from "@client/core/network/server-connection/normalization/InboundPayloads";
