import type { TradeServerPayload } from "@client/core/network/server-connection/types/index";
import { cloneTradeState, createDefaultTradeState } from "@client/core/network/server-connection/domain/defaults";
import { state } from "@client/core/network/server-connection/state";
import { sanitizeTradePartyMessage } from "@client/core/network/server-connection/normalization/InboundPayloads";
