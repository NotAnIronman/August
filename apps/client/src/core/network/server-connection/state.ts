...
import { CombatStateStore } from "@client/core/network/combat/CombatStateStore";
import { DEFAULT_URL } from "@client/core/network/server-connection/constants";
import {
    createDefaultShopState,
    createDefaultSmithingState,
    createDefaultTradeState,
} from "@client/core/network/server-connection/domain/defaults";
import type {
    BankServerUpdate,
    ChatMessageEvent,
...
export const state = {
    ...
    lastBankState: undefined as { capacity: number; slots: import("@client/core/network/server-connection/types").BankSlotMessage[] } | undefined,
