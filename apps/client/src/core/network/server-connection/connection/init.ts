...
import { processServerMessage } from "@client/core/network/server-connection/handlers/dispatch";
...
import { initSocketCloseHandler } from "@client/core/network/server-connection/connection/closeHandler";
    ...
    try {
        ...
        ws.addEventListener("open", () => {
            ...
            // When using login screen, handshake should be sent after login success
                ...
                const { isMobileMode } = require("@client/core/platform/device/DeviceUtil");
        ...
        ws.addEventListener("message", (evt) => {
            ...
            try {
                ...
                if (raw instanceof ArrayBuffer) {
                    ...
                    const { decodeBatchedServerPackets } = require("@client/core/network/packet/ServerBinaryDecoder");
