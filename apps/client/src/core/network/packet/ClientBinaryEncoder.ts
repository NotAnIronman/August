/**
 * ClientBinaryEncoder - Encode August client messages to binary format
 *
...
export class ClientPacketBuffer {
    ...
    toPacket(opcode: ClientMessageId): Uint8Array {
        const length = CLIENT_MESSAGE_LENGTHS[opcode];
...
export class ClientBinaryEncoder {
    ...
    encodeHello(client: string, version?: string): Uint8Array {
        ...
        return this.buffer.toPacket(ClientMessageId.HELLO);
    }

    encodePing(time: number): Uint8Array {
        this.buffer.reset();
        this.buffer.writeInt(time);
        return this.buffer.toPacket(ClientMessageId.PING);
    }
    ...
    encodeHandshake(name?: string, appearance?: any, clientType?: number): Uint8Array {
        ...
        return this.buffer.toPacket(ClientMessageId.HANDSHAKE);
    }

    encodeLogout(): Uint8Array {
        this.buffer.reset();
        return this.buffer.toPacket(ClientMessageId.LOGOUT);
    }
    ...
    encodeLogin(username: string, password: string, revision: number): Uint8Array {
        ...
        return this.buffer.toPacket(ClientMessageId.LOGIN);
    }
    ...
    encodeWalk(x: number, y: number, run?: boolean, modifierFlags?: number): Uint8Array {
        ...
        return this.buffer.toPacket(ClientMessageId.WALK);
    }
    ...
    encodeFace(rot?: number, tile?: { x: number; y: number }): Uint8Array {
        ...
        return this.buffer.toPacket(ClientMessageId.FACE);
    }
    ...
    encodeTeleport(x: number, y: number, level?: number): Uint8Array {
        ...
        return this.buffer.toPacket(ClientMessageId.TELEPORT);
    }
    ...
    encodePathfind(
        ...
        return this.buffer.toPacket(ClientMessageId.PATHFIND);
    }
    ...
    encodeLocInteract(
        ...
        return this.buffer.toPacket(ClientMessageId.LOC_INTERACT);
    }
    ...
    encodeInteract(mode: "follow" | "trade", targetId: number): Uint8Array {
        ...
        return this.buffer.toPacket(ClientMessageId.INTERACT);
    }

    encodeInteractStop(): Uint8Array {
        this.buffer.reset();
        return this.buffer.toPacket(ClientMessageId.INTERACT_STOP);
    }
    ...
    encodeInventoryUse(
        ...
        return this.buffer.toPacket(ClientMessageId.INVENTORY_USE);
    }
    ...
    encodeInventoryUseOn(slot: number, itemId: number, target: any): Uint8Array {
        ...
        return this.buffer.toPacket(ClientMessageId.INVENTORY_USE_ON);
    }
    ...
    encodeInventoryMove(from: number, to: number): Uint8Array {
        ...
        return this.buffer.toPacket(ClientMessageId.INVENTORY_MOVE);
    }

    encodeBankDepositInventory(): Uint8Array {
        this.buffer.reset();
        return this.buffer.toPacket(ClientMessageId.BANK_DEPOSIT_INVENTORY);
    }

    encodeBankDepositEquipment(): Uint8Array {
        this.buffer.reset();
        return this.buffer.toPacket(ClientMessageId.BANK_DEPOSIT_EQUIPMENT);
    }
    ...
    encodeBankMove(from: number, to: number, mode?: "swap" | "insert", tab?: number): Uint8Array {
        ...
        return this.buffer.toPacket(ClientMessageId.BANK_MOVE);
    }
    ...
    encodeWidget(action: "open" | "close", groupId: number, modal?: boolean): Uint8Array {
        ...
        return this.buffer.toPacket(ClientMessageId.WIDGET);
    }
    ...
    encodeWidgetAction(payload: any): Uint8Array {
        ...
        return this.buffer.toPacket(ClientMessageId.WIDGET_ACTION);
    }

    encodeItemSpawnerSearch(query: string): Uint8Array {
        this.buffer.reset();
        this.buffer.writeString(query ?? "");
        return this.buffer.toPacket(ClientMessageId.ITEM_SPAWNER_SEARCH);
    }
    ...
    encodeResumePausebutton(widgetId: number, childIndex: number): Uint8Array {
        ...
        return this.buffer.toPacket(ClientMessageId.RESUME_PAUSEBUTTON);
    }

    encodeResumeCountdialog(value: number): Uint8Array {
        this.buffer.reset();
        this.buffer.writeInt(value | 0);
        return this.buffer.toPacket(ClientMessageId.RESUME_COUNTDIALOG);
    }

    encodeResumeNamedialog(value: string): Uint8Array {
        this.buffer.reset();
        this.buffer.writeString(value ?? "");
        return this.buffer.toPacket(ClientMessageId.RESUME_NAMEDIALOG);
    }

    encodeResumeStringdialog(value: string): Uint8Array {
        this.buffer.reset();
        this.buffer.writeString(value ?? "");
        return this.buffer.toPacket(ClientMessageId.RESUME_STRINGDIALOG);
    }
    ...
    encodeIfButtond(payload: any): Uint8Array {
        ...
        return this.buffer.toPacket(ClientMessageId.IF_BUTTOND);
    }
    ...
    encodeEmote(index: number, loop?: boolean): Uint8Array {
        ...
        return this.buffer.toPacket(ClientMessageId.EMOTE);
    }
    ...
    encodeTradeAction(payload: any): Uint8Array {
        ...
        this.buffer.writeShort(payload.itemId ?? -1);
        return this.buffer.toPacket(ClientMessageId.TRADE_ACTION);
    }
    ...
    encodeFriendsChatAction(payload: FriendsChatAction): Uint8Array {
        ...
        return this.buffer.toPacket(ClientMessageId.FRIENDS_CHAT_ACTION);
    }
    ...
    encodeDebug(payload: any): Uint8Array {
        ...
        return this.buffer.toPacket(ClientMessageId.DEBUG);
    }
}
