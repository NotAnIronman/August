...
import type { WidgetManager, WidgetNode } from "@client/ui/widgets/WidgetManager";
...
import type { EnumType } from "@august/osrs-engine/config/enumtype/EnumType";
...
import type { ParamTypeLoader } from "@august/osrs-engine/config/paramtype/ParamTypeLoader";
import type { StructType } from "@august/osrs-engine/config/structtype/StructType";
...
import type { WorldMapState } from "@august/osrs-engine/map/WorldMapArea";
...
import {
    ...
    createHandlerMap,
} from "@client/engine/cs2/handlers/index";
