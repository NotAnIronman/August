...
import { getClientClock } from "@client/engine/game/TransmitCycles";
import { getSafeAreaBounds, isTouchDevice } from "@client/core/platform/device/DeviceUtil";
import { VARBIT_ROOF_REMOVAL } from "@august/game-model/state/vars";
