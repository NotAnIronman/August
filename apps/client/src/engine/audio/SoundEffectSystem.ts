...
import type { SeqSoundEffect } from "@august/osrs-engine/config/seqtype/SeqType";
import {
...
} from "@client/engine/audio/audioContext";
import { resampleToSampleRate, smoothLowPass } from "@client/engine/audio/resample";
