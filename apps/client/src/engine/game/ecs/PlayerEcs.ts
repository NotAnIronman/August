...
import { NO_INTERACTION, decodeInteractionIndex } from "@august/osrs-engine/interaction/InteractionIndex";
    ...
    ensureBaseForAppearance(
        ...
        try {
            ...
            const PlayerModelLoader =
                require("@august/osrs-engine/config/player/PlayerModelLoader").PlayerModelLoader;
            ...
            try {
                const NpcModelLoader =
                    require("@august/osrs-engine/config/npctype/NpcModelLoader").NpcModelLoader;
