import type { Scene } from "@august/osrs-engine/scene/Scene";
import type { SceneTile } from "@august/osrs-engine/scene/SceneTile";
import { TILE_FLAG_BRIDGE, TILE_FLAG_FORCE_LOWEST_PLANE } from "@client/engine/game/scene/TileRenderFlags";
