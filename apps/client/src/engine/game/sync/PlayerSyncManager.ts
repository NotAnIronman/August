import { playerTypeIdToModIcon } from "@august/osrs-engine/chat/PlayerType";
import {
    NO_INTERACTION,
...
import type { NpcEcs } from "@client/engine/game/ecs/NpcEcs";
import { PlayerEcs } from "@client/engine/game/ecs/PlayerEcs";
import type { MovementUpdate } from "@client/engine/game/movement/MovementSyncTypes";
import { PlayerMovementSync } from "@client/engine/game/movement/PlayerMovementSync";
import type { ResolveTilePlaneFn } from "@client/engine/game/scene/PlaneResolver";
import { decodeAppearanceBinary } from "@client/engine/game/sync/AppearanceDecoder";
import { frameToActions } from "@client/engine/game/sync/PlayerSyncActions";
import type {
    ...
    PlayerSyncFrame,
    SpotAnimationUpdate,
} from "@client/engine/game/sync/PlayerSyncTypes";
