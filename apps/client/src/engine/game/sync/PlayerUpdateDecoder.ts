import { normalizePublicChatTextOsrs } from "@august/osrs-engine/chat/ChatText";
import {
    MovementDirection,
    directionToDelta,
    runDirectionToDelta,
} from "@august/game-model/movement/Direction";
import { BitStream } from "@client/engine/game/sync/BitStream";
import { getPlayerSyncHuffman } from "@client/engine/game/sync/HuffmanProvider";
import { PlayerSyncContext, type PlayerSyncState } from "@client/engine/game/sync/PlayerSyncContext";
import {
