import { OsrsClientPacket, type PacketBufferNode, createPacket } from "@client/core/network/packet/index";
import type { NormalizedSelectedSpellPayload } from "@august/protocol/spells/selectedSpellPayload";
