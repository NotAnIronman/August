...
import type { WorldMapArchiveRenderer } from "@august/osrs-engine/map/WorldMapArchiveRenderer";
...
export { scheduleWorldMapImageRepaint } from "@client/engine/game/world-map/WorldMapRepaint";
