...
import type { WorldEntityTypeLoader } from "@august/osrs-engine/config/worldentitytype/WorldEntityTypeLoader";
import type { SkeletalBase } from "@august/osrs-engine/model/skeletal/SkeletalBase";
import type { SkeletalSeq } from "@august/osrs-engine/model/skeletal/SkeletalSeq";
