...
import * as render from "@client/engine/rendering/render/index";
import { RENDER_CONSTANTS, TextureFilterMode, HD_SKY_COLOR_VEC4, HD_AUTO_FOG_DEPTH_FACTOR } from "@client/engine/rendering/render/constants";
import type {
...
export { formatPlayerCombatLabel } from "@client/engine/rendering/render/constants";
export type {
    BrowserQualityProfile,
    BrowserQualityProfileKey,
    ColorRgb,
...
export class WebGLOsrsRenderer extends GameRenderer<WebGLMapSquare> {
    ...
    public ambientSoundBuffer: import("@client/engine/audio/SoundEffectSystem").AmbientSoundInstance[] = [];
