...
import { ArchiveHitSplatTypeLoader } from "@august/osrs-engine/config/hitsplat/HitSplatTypeLoader";
...
import { HitsplatEntry, Overlay, OverlayInitArgs, OverlayUpdateArgs, RenderPhase } from "@client/engine/rendering/overlays/Overlay";
