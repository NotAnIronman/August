...
import { isTouchDevice } from "@client/core/platform/device/DeviceUtil";
import { getUiScale } from "@client/ui/runtime/UiScale";
import { FONT_VERDANA_13 } from "@august/protocol/ui/fonts";
import { getChooseOptionMenuRect } from "@client/ui/widgets/gl/widgets-gl/menu/ChooseOptionMenu";
...
import {
    ...
    renderWidgetTreeGL,
} from "@client/ui/widgets/gl/widgets-gl/index";
import { drawTextGL } from "@client/ui/widgets/components/TextRenderer";
import type { WidgetManager } from "@client/ui/widgets/WidgetManager";
import {
    getAnimatedItemIconPhase,
    getAnimatedItemIconTimeSeconds,
    hasAnimatedItemIcon,
} from "@client/ui/runtime/item/animatedItemIcons";
...
export class WidgetsOverlay implements Overlay {
    ...
    private getOverlayRenderSize(): { width: number; height: number } {
        ...
        for (const canvas of canvases) {
            ...
            // Propagate renderScaleX from the main canvas so the Choose Option menu and other
