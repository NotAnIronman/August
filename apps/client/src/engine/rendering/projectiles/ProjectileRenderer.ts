...
import type { WebGLMapSquare } from "@client/engine/rendering/WebGLMapSquare";
import type { WebGLOsrsRenderer } from "@client/engine/rendering/WebGLOsrsRenderer";
import type { GfxCache } from "@client/engine/rendering/gfx/GfxCache";
import type { SpotAnimGpuCache, SpotAnimGpuRecord } from "@client/engine/rendering/gfx/SpotAnimGpuCache";
import { sampleBridgeHeightForWorldTile } from "@client/engine/game/scene/BridgeHeightSampler";
import { BridgePlaneStrategy } from "@client/engine/game/scene/PlaneResolver";
import type { Projectile } from "@client/engine/rendering/projectiles/Projectile";
