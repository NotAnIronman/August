import type { CacheItemSearchEntry } from "@august/osrs-engine/config/objtype/CacheItemSearchIndex";
import {
...
import { escapeItemSpawnerSearchText, itemSpawnerUids } from "@client/features/item-spawner/ItemSpawnerUids";
import {
