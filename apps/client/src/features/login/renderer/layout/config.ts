import { getOrientation, isMobileMode, isTouchDevice } from "@client/core/platform/device/DeviceUtil";
...
import type { LoginLayoutConfig } from "@client/features/login/renderer/types";
