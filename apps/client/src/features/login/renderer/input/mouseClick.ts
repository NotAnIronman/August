import { GameState, LoginIndex } from "@client/features/login/GameState";
import { LoginActions } from "@client/features/login/LoginAction";
import type { LoginState } from "@client/features/login/LoginState";
import type { LoginAction } from "@client/features/login/LoginAction";
import type { LoginRendererHost } from "@client/features/login/renderer/host";
import { toLayoutPoint } from "@client/features/login/renderer/layout/config";
import { toContentPoint } from "@client/features/login/renderer/layout/geometry";
import { isTitleMuteHit } from "@client/features/login/renderer/controls";
import { getServerListButtonPosition } from "@client/features/login/renderer/layout/geometry";
...
import {
    ...
    isButtonHit,
} from "@client/features/login/renderer/input/mouseHandlers";
