...
export function handleLoginFormClick(host: LoginRendererHost, state: LoginState, x: number, y: number, gameState: import('@client/features/login/GameState').GameState) {
