...
import {
    ...
    drawAuthenticator,
} from "@client/features/login/renderer/render/loginScreensPrimary";
import {
    drawForgotPassword,
    drawMessage,
    drawDateOfBirth,
    ...
    drawTerms,
    drawMustAcceptTerms,
} from "@client/features/login/renderer/render/loginScreensSecondary";
import {
    drawBanned,
    drawOkMessage,
    drawDobNotSet,
    ...
    drawWorldHopWarning,
} from "@client/features/login/renderer/render/loginScreensTertiary";
