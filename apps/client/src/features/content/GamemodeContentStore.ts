import type {
    ...
    LeagueRelicRow,
    LeagueTaskRow,
} from "@august/protocol/gamemode/GamemodeDataTypes";
...
export function loadFromPayload(payload: {
    ...
    for (const dataset of payload.datasets) {
        switch (dataset.key) {
            ...
            case "customItems":
                try {
                    const { CustomItemRegistry } = require("@august/custom-content/items/CustomItemRegistry");
                    const { CustomItemBuilder } = require("@august/custom-content/items/CustomItemBuilder");
