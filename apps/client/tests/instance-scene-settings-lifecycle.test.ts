...
async function run(): Promise<void> {
    ...
    } = await import("@client/engine/rendering/render/instance"));
    ({ onLocChange } = await import("@client/engine/rendering/render/locs"));
    ({ onLocDel } = await import("@client/engine/rendering/render/locs2"));
    ({ isValidMapData } = await import("@client/engine/rendering/render/map"));
    ({ setLoadNpcs, setSmoothTerrain } = await import("@client/engine/rendering/render/settings"));
