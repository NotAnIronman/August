import { COSINE, SINE } from "@august/osrs-engine/MathConstants";
...
import { blendLight } from "@august/osrs-engine/graphics/color/OsrsColor";
import { FaceNormal } from "@august/osrs-engine/model/FaceNormal";
import { Model } from "@august/osrs-engine/model/Model";
import { LegacyModelLoader, LegacyModelMetadata } from "@august/osrs-engine/model/ModelLoader";
import { computeTextureCoords } from "@august/osrs-engine/model/TextureMapper";
import { VertexNormal } from "@august/osrs-engine/model/VertexNormal";
...
export class ModelData extends Entity {
    ...
    static adjustLightness(hsl: number, lightness: number): number {
        return blendLight(hsl, lightness);
    }
    ...
    static mergeNormals(
        ...
        // OPTIMIZATION: Build spatial hash map for model1 vertices
        // This turns O(n*m) nested loop into O(n+m) hash lookup
