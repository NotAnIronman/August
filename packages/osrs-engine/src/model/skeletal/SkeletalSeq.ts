...
import { SeqBase } from "@august/osrs-engine/model/seq/SeqBase";
import { SeqBaseLoader } from "@august/osrs-engine/model/seq/SeqBaseLoader";
import { Curve } from "@august/osrs-engine/model/skeletal/Curve";
import { getCurveIndex, getCurveTypeForId } from "@august/osrs-engine/model/skeletal/CurveType";
...
import { SkeletalBase } from "@august/osrs-engine/model/skeletal/SkeletalBase";
import { SkeletalBone } from "@august/osrs-engine/model/skeletal/SkeletalBone";
import {
    SkeletalTransformType,
    getCurveCount,
    getTransformTypeForId,
} from "@august/osrs-engine/model/skeletal/SkeletalTransformType";
