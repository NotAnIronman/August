...
import { generateHeight } from "@august/osrs-engine/scene/terrain/TerrainHeightGenerator";
...
import { EntityType, calculateEntityTag, getIdFromTag } from "@august/osrs-engine/scene/entity/EntityTag";
