import type { ByteBuffer } from "@august/osrs-engine/io/ByteBuffer";
import type { DbColumnDefinition } from "@august/osrs-engine/config/db/DbTableDefinition";
import { DbTableDefinition } from "@august/osrs-engine/config/db/DbTableDefinition";
import { ScriptVarTypeId, decodeScriptVarValue } from "@august/osrs-engine/config/db/ScriptVarType";
