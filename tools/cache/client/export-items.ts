...
import { EquipmentSlot, deriveEquipSlotFromParams } from "@august/osrs-engine/config/player/Equipment";
import { ArchiveStructTypeLoader } from "@august/osrs-engine/config/structtype/StructTypeLoader";
