...
import { readSingleDoorDefsFromFile } from "@server/world/DoorCatalogFile";
import { serverCatalogPath, serverVarPath } from "@tools/lib/repository-paths";
...
function loadExistingSingleDoors(): ExistingSingleDoor[] {
    const file = serverCatalogPath("doors.json");
...
function main(): void {
    ...
    const existing = loadExistingSingleDoors();
