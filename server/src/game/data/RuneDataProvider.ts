...
export const RUNE_IDS: RuneId = new Proxy({} as RuneId, {
    get(_target, prop) {
...
export const COMBINATION_RUNES: CombinationRune[] = new Proxy([] as CombinationRune[], {
    get(target, prop, receiver) {
        const provider = getRuneDataProvider();
        if (provider) {
...
export const STAFF_SUBSTITUTIONS: StaffSubstitution[] = new Proxy([] as StaffSubstitution[], {
    get(target, prop, receiver) {
        const provider = getRuneDataProvider();
        if (provider) {
