...
import { princeAliRescueQuest } from "../gamemodes/vanilla/quests/definitions/princeAliRescue";
import {
    BLONDE_WIG_ITEM_ID,
    BRONZE_KEY_ITEM_ID,
    GREY_WIG_ITEM_ID,
    ...
    YELLOW_DYE_ITEM_ID,
} from "../gamemodes/vanilla/quests/definitions/princeAliRescue/constants";
