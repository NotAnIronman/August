 ...
 *
 * Usage:
 *   yarn --cwd server sync-equipment-requirements
 *   yarn --cwd server sync-equipment-requirements -- --source-dir ../references/skill-guide
 */
import fs from "fs";
...
const DESTINATION = path.resolve(SCRIPT_DIR, "../../references/osrs-equipment-requirements.json");
