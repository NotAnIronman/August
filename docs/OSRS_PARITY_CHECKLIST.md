# XRSPS → OSRS Feature Parity Checklist
...
- [FIXED THIS SESSION] Legacy/new dual binary protocol — found and fixed a
  ...
  `docs/CLEANUP_ROADMAP.md` Phase 3.
...
- [CODE] Shops (`gamemodes/vanilla/shops/`, `shops.json` data) — not tested
